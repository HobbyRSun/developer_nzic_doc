...
PLC的电源部分，主要包括系统供电部分和芯片内核电源部分，其中系统供电的输入一般有220V的交流输入、隔离的24V直流输入、非隔离的24V直流输入，芯片内核电源主要有3.3V和1.2V两个电源，这里对这几个电源的设计逐一进行说明。

#### 交流输入

AC220V转DC24V推荐电路如下图所示，此电路为单端反激式开关电源，两路24V输出，单路最大0.5A，总输出功率24W。

![Image: image_001](./基于CMC控制芯片的PLC硬件设计方案_images/image_001.png)
...
![Image: image_002](./基于CMC控制芯片的PLC硬件设计方案_images/image_002.png)
...
![Image: image_003](./基于CMC控制芯片的PLC硬件设计方案_images/image_003.png)
...
![Image: image_004](./基于CMC控制芯片的PLC硬件设计方案_images/image_004.png)
...
![Image: image_005](./基于CMC控制芯片的PLC硬件设计方案_images/image_005.png)
...
![Image: image_006](./基于CMC控制芯片的PLC硬件设计方案_images/image_006.png)![Image: image_007](./基于CMC控制芯片的PLC硬件设计方案_images/image_007.png)![Image: image_008](./基于CMC控制芯片的PLC硬件设计方案_images/image_008.png)
</figure>
...
![Image: image_009](./基于CMC控制芯片的PLC硬件设计方案_images/image_009.png)
...
![Image: image_010](./基于CMC控制芯片的PLC硬件设计方案_images/image_010.png)
...
![Image: image_011](./基于CMC控制芯片的PLC硬件设计方案_images/image_011.png)
...
![Image: image_012](./基于CMC控制芯片的PLC硬件设计方案_images/image_012.png)
...
![Image: image_013](./基于CMC控制芯片的PLC硬件设计方案_images/image_013.png)
...
![Image: image_014](./基于CMC控制芯片的PLC硬件设计方案_images/image_014.png)
...
![Image: image_015](./基于CMC控制芯片的PLC硬件设计方案_images/image_015.png)
...
![Image: image_016](./基于CMC控制芯片的PLC硬件设计方案_images/image_016.png)
...
![Image: image_017](./基于CMC控制芯片的PLC硬件设计方案_images/image_017.png)
...
![Image: image_018](./基于CMC控制芯片的PLC硬件设计方案_images/image_018.png)
...
![Image: image_019](./基于CMC控制芯片的PLC硬件设计方案_images/image_019.png)![Image: image_020](./基于CMC控制芯片的PLC硬件设计方案_images/image_020.png)
...
![Image: image_021](./基于CMC控制芯片的PLC硬件设计方案_images/image_021.png)
...
![Image: image_022](./基于CMC控制芯片的PLC硬件设计方案_images/image_022.png)
...
| 7 | L1 | 滤波器 DLM11SN900HY2 90Ω@100KHz 0.1A | 1 |
...
此推荐电路采用的模数转换芯片为MAX11612，精度12位，支持4路模拟量输入，内部基准电压2.048V。此电路模数转换芯片采用I2C通讯，需注意有多路I2C设备时地址是否有冲突。

![Image: image_023](./基于CMC控制芯片的PLC硬件设计方案_images/image_023.png)![Image: image_024](./基于CMC控制芯片的PLC硬件设计方案_images/image_024.png)
...
![Image: image_025](./基于CMC控制芯片的PLC硬件设计方案_images/image_025.png)
...
![Image: image_026](./基于CMC控制芯片的PLC硬件设计方案_images/image_026.png)
...
![Image: image_027](./基于CMC控制芯片的PLC硬件设计方案_images/image_027.png)
...
![Image: image_028](./基于CMC控制芯片的PLC硬件设计方案_images/image_028.png)
...
![Image: image_029](./基于CMC控制芯片的PLC硬件设计方案_images/image_029.png)
...
![Image: image_030](./基于CMC控制芯片的PLC硬件设计方案_images/image_030.png)
...
![Image: image_031](./基于CMC控制芯片的PLC硬件设计方案_images/image_031.png)
...
差分信号通过专用的差分转单端的驱动芯片将差分信号转为单端信号接到CMC芯片，最多支持12路脉冲输入或6组正交计数输入，驱动芯片采用AM26C32I支持4组差分信号输入，用户可以根据设计需求选择通道数量，推荐电路如下图所示。

![Image: image_032](./基于CMC控制芯片的PLC硬件设计方案_images/image_032.png)
...
单端信号通过驱动芯片进行电平转换，将信号接到CMC芯片，最多支持12路脉冲输入或6组正交计数输入，驱动芯片采用AM26C32I支持4路信号输入，用户可以根据设计需求选择通道数量，推荐电路如下图所示。

![Image: image_033](./基于CMC控制芯片的PLC硬件设计方案_images/image_033.png)
...
差分脉冲输出通过专用的单端转差分的驱动芯片将单端信号转为差分信号输出到外部设备，CMC芯片支持4组脉冲信号输出，最大频率4MHz，驱动芯片采用AM26C31I支持4组差分信号输出，用户可以根据设计需求选择通道数量，推荐电路如下图所示。

![Image: image_034](./基于CMC控制芯片的PLC硬件设计方案_images/image_034.png)
...
单端脉冲输出通常为兼容DO输出，故方案采用高速光耦隔离，驱动MOS管方式进行输出，推荐电路如下图所示。

![Image: image_035](./基于CMC控制芯片的PLC硬件设计方案_images/image_035.png)
...
| 2 | 贴片电容 0805 10uf±10%/25V X5R | 2 |  |  |
| 3 | 电源芯片 LD1086DT33TR | 1 |  |  |
| 4 | 贴片电容 0603 0.1uf±10%/50V X7R | 2 |  |  |
| 5 | 贴片电容 0805 10uf±10%/25V X5R | 2 |  |  |
| 6 | 电源芯片 LD1117DT12CTR | 1 |  |  |
...
| 2 | 贴片电容 0603 15pf±5%/50V NP0 | 1 |  |  |
| 3 | 贴片电容 0603 1uf±10%/50V X5R | 1 |  |  |
| 4 | 贴片电阻 0603 100Ω±1% | 2 |  |  |
| 5 | 贴片电阻 0603 10KΩ±1% | 5 |  |  |
| 6 | 有源晶振 10MHz±20ppm | 1 |  |  |
| 7 | CMC芯片 CMC693PR144 | 1 |  |  |
| 8 | 连接器 5Pin-2.0mm双排针 | 1 |  |  |
